# -*- coding: utf-8 -*-
"""
Created on Thu Apr 27 12:22:54 2023
...
df=pd.read_csv("imputeddaysanmarcos.csv")
...
#splitting the data into testing and training sets (75% train-25%test)
Train = df.iloc[:18323, 2:3]
training_set = df.iloc[:18323, 2:3].values
Test = df.iloc[18323:, 2:3]
test_set = df.iloc[18323:, 2:3].values
...
X = 10
dataset_train = df.iloc[:18323, 2:3]
dataset_test = df.iloc[18323:, 2:3]
dataset_test.shape
...
plt.title('Discharge prediction' , fontsize=15)
plt.xlabel('Date', fontsize=15)
plt.ylabel('Discharge' ,fontsize=15)
plt.plot(Train['Discharge_cfs'],linewidth=3)
plt.plot(Test['Discharge_cfs'],linewidth=3)
...
plt.title('Discharge prediction' , fontsize=15)
plt.xlabel('Date', fontsize=15)
plt.ylabel('Discharge_cfs' ,fontsize=15)
plt.plot(Test['Discharge_cfs'],linewidth=3)
plt.plot(Test["Prediction"],linewidth=3)
