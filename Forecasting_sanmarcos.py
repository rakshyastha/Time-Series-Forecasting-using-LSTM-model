# -*- coding: utf-8 -*-
"""
Created on Thu Apr 27 12:56:13 2023
...
df=pd.read_csv("imputeddaycomal.csv")
...
Train = df.iloc[:26114, 2:3]
training_set = df.iloc[:26114, 2:3].values
Test = df.iloc[26114:, 2:3]
test_set = df.iloc[26114:, 2:3].values
...
X = 10
dataset_train = df.iloc[:26114, 2:3]
dataset_test = df.iloc[26114:, 2:3]
dataset_test.shape
